...
interface JewelrySpriteUploadFormProps {
  jewelryId: string;
  blobConfigured: boolean;
}

/**
 * Manual sprite upload — admin uploads an already-transparent PNG made
 * elsewhere (Photoshop, online cutout tool). The auto bg-removal flow
 * lands in Task 3 of the lite-mode roadmap; until then, this is the
 * only path. After Task 3 it stays as the override for ugly auto cuts.
 */
export function JewelrySpriteUploadForm({
  jewelryId,
  blobConfigured,
}: JewelrySpriteUploadFormProps) {
