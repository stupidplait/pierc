...
/**
 * DetailModal — the in-catalog "examine item" panel. Opened via ?inspect=id
...
export function DetailModal({
  ...
  // Dialog a11y while open: body scroll lock, focus moved into the panel, a Tab
  // focus-trap, Escape to close, and focus restored to the trigger on close —
  // mirroring the Drawer/ConfirmDialog recipe.
  useEffect(() => {
    if (!piece) return;
