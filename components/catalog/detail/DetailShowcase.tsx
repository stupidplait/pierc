...
/**
 * Variant C — "Showcase". The piece's interactive 3D model is the hero,
 * orbitable front-and-center on a dark stage, with a compact detail column
 * beside it and a thumbnail strip of photos below the model. When the piece
 * has no GLB, the hero falls back to the first photo so the layout still
 * reads. Best for pieces with a good model — the most "wow" / on-brand option.
 */
export function DetailShowcase({ piece, user }: DetailViewProps) {
