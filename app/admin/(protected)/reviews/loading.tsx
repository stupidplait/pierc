  ...
  return (
    <div aria-hidden="true" className="mx-auto w-full max-w-6xl">
      ...
      <header className="mb-8 flex flex-col gap-5 pt-2 sm:mb-10 sm:flex-row sm:items-end sm:justify-between sm:pt-4">
        ...
        <div className="h-10 w-28 shrink-0 animate-pulse rounded-xl bg-card" />
      </header>

      {/* Status filter strip (left) + "featured only" toggle (right). */}
      <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="h-8 w-40 shrink-0 animate-pulse rounded-xl bg-card" />
      </div>
