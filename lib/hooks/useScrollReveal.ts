 ...
 *
 * @param threshold - fraction of element visible to trigger (default 0.25
 *   so reveal fires once the section is well-entered, ≈75% scrolled in
 *   from the bottom — the standard pattern used by Linear / Vercel)
